    ...
    <Card padding="lg">
      ...
      <div className="space-y-2 text-sm">
        ...
        <p>
          ...
          <code>/events</code> en luister naar <code>snapshot</code> en{" "}
          <code>delta</code> events
        </p>
        <p>
          <strong>Testen:</strong> Gebruik de browser developer tools om events
          te inspecteren en de Network tab om SSE berichten te zien
        </p>
      </div>
    </Card>
  );
